...
KyrieOrgano = {
  \relative c {
    ...
    r8 \mvTr b-!\fE-\solo-\tasto d-! b-! f'-! d-! b'-! b,-!
    r b es b g' es b' b,
    r b d b f' d b' b,
    r \mvTr es\p-\senzaOrg es es f f f f
    g g g g a a a a %5
    \mvTr b\fE-\tutti-\accomp b, d b f' d b' b,
    r b es b g' es b' b,
    r b d b f' d b' b,
    r es g es b' g es' es,
    ...
    b b d b f' d b' b,
    r es es es e e e e
    f4 f,8 \noBeam \mvTr f'\pE-\senzaOrg g g g g
    a a a a b b b b
    \mvTr f\fE-\accomp f f f g g g g %15
    a a a a b b b b
    f es d b f' es f f,
    b b-!-\tasto d-! b-! f'-! d-! b' b,
    r a-\solo c a f' c a' a,
    r g b g e' b g' g, %20
    f-\tutti-\accomp f' a f e c e c
    r f a f e c e c
    r f a f f,4 r
    b\p r c r
...
KyrieBassFigures = \figuremode {
  ...
  r %45
  r
  r2 <5 4 2>4. \bassFigureExtendersOn q8
